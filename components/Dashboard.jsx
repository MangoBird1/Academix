...
import { useSidebarCollapsed } from '@/components/PageShell';
...
export default function AcademixTealDashboard({ initialApplications = [] }) {
  ...
  return (
    <div
      className={`flex flex-1 h-full w-full overflow-hidden relative gap-2 p-4 ${
    ...
    >
        ...
        <section
          ...
          className={`shrink-0 bg-[#e8f0f7] rounded-xl shadow-sm ${paneCard} ${sidebarCollapsed ? 'pt-12' : ''}`}>
        ...
        <section style={{ width: pane3Width }} className={`shrink-0 bg-[#d7e1ea] rounded-xl shadow-sm ${paneCard} ${sidebarCollapsed ? 'pt-12' : ''}`}>
